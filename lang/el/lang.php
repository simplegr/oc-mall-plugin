...
return [
    ...
    'titles' => [
        'products' => [
            'create' => 'Προσθήκη Προϊόντος',
            'update' => 'Επεξεργασία Προϊόντος',
            'preview' => 'Προεπισκόπηση Προϊόντος',
        ],
        'categories' => [
            'create' => 'Προσθήκη Κατηγορίας',
            'update' => 'Επεξεργασία Κατηγορίας',
            'preview' => 'Προεπισκόπηση Κατηγορίας',
        ],
        'orders' => [
            'show' => 'Order details',
